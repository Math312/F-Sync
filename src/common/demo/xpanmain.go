...
const (
	MyAccessToken = "123.7762029b59e60cc85f1d5396ee2fe37f.Yg5RdwKy6ZK6dMct0QAMASHGZicl_1uN-N41F1n.xaSXIw"
)
...
func MyPcssuperfile2(uplodidTmp string) {
	...
	type_ := "tmpfile"
	file, err := os.Open("D:\\Code\\F-Sync\\src\\common\\demo\\data\\1.txt")
	if err != nil {
		fmt.Println(err)
	}
	defer file.Close()
